...
for g in glyphs:
    ...
    for t in [0.05 * n for n in range(21)]:
        ...
        pen.moveTo((83, 620))
        pen.lineTo((83, 582))
        pen.curveTo((83, 549), (45, 377), (45, 282))
        pen.curveTo((45, 88), (55, -2), (149, -2))
        pen.curveTo((170, -2), (186, 20), (186, 45))
        pen.curveTo((186, 91), (152, 51), (152, 201))
        pen.lineTo((152, 245))
        pen.curveTo((152, 287), (153, 342), (162, 342))
        pen.curveTo((174, 342), (211, 237), (315, 237))
        pen.curveTo((410, 237), (465, 325), (478, 325))
        pen.curveTo((479, 325), (480, 321), (480, 312))
        pen.lineTo((480, 290))
        pen.curveTo((480, 229), (481, 105), (563, 105))
        pen.curveTo((596, 105), (608, 135), (608, 143))
        pen.curveTo((608, 153), (591, 210), (591, 313))
        pen.curveTo((591, 379), (621, 435), (621, 527))
        pen.curveTo((621, 580), (597, 615), (542, 615))
        pen.curveTo((473, 615), (435, 339), (318, 339))
        pen.curveTo((205, 339), (265, 659), (153, 659))
        pen.curveTo((125, 659), (83, 651), (83, 620))
        pen.closePath()
        pen.moveTo((83, 620))
        pen.lineTo((83, 582))
        pen.curveTo((83, 549), (45, 377), (45, 282))
